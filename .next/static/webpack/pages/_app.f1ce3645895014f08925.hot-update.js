...
})(["background-color:", ";color:", ";position:absolute;padding:6px 20px;border:none;cursor:pointer;width:30px;height:30px;border-radius:50%;display:flex;justify-content:center;align-items:center;right:20px;top:150px;z-index:10;"], function (_ref) {
