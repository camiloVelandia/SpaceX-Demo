...
})(["width:80%;background-color:", ";position:relative;z-index:5;padding:40px;border-radius:25px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;"], function (_ref) {
...
})(["padding-top:20px;& h3{font-size:18px;font-weight:400;text-transform:uppercase;}& ul{list-style:none;padding:0;& a{color:", ";padding-bottom:4px;}}"], function (_ref2) {
